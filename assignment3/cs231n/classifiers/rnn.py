...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        x, cache_em = word_embedding_forward(captions_in, W_embed)
        ...
        dW_embed = word_embedding_backward(dx, cache_em)
    ...
    def sample(self, features, max_length=30):
        ...
        V, W = W_embed.shape
        x = np.ones((N, W)) * W_embed[self._start] # (N, W) * (W,)
