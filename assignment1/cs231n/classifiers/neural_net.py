...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        grad_W2 = y1.T @ grad_scores / N
        grad_b2 = np.sum(grad_scores, axis=0) / N

        grad_y1 = grad_scores @ W2.T
        grad_y1[y1 <= 0] = 0
        grad_W1 = X.T @ grad_y1 / N
        grad_b1 = np.sum(grad_y1, axis=0) / N

        grads["W2"] = grad_W2 + reg * 2 * W2
        grads["W1"] = grad_W1 + reg * 2 * W1
        grads["b2"] = grad_b2
        grads["b1"] = grad_b1
